...
22년 7월부터 라인 플러스에서 서버 개발자로 일하게 되었습니다. <br>
뒤늦게 시작했지만 다른 이들에 비해 뒤쳐진 것을 따라 잡고 동등한 수준을 갖춘 개발자로 먼저 성장하는 것이 목표입니다. <br>
추후에는 다양한 패턴과 개념의 추상화 과정을 이해하고, 그것을 구조에 녹여내고 싶습니다. <br>
이를 통해 대용량 트래픽에 대응 가능한 단단한 구조를 설계하고 유지보수가 편리한 코드로 구현하는 백엔드 개발자로 성장하는 것이 목표입니다. <br>
